...
class ObjectivesControllerTest < ActionController::TestCase
  ...
  test "should create objective" do
    assert_difference("Objective.count") do
      post :create, objective: { name: @objective.name, due_year: @objective.due_year, due_quarter: @objective.due_quarter, user_id: @objective.user_id }
    end
  ...
  test "should update objective" do
    patch :update, id: @objective, objective: { name: @objective.name, due_year: @objective.due_year, due_quarter: @objective.due_quarter, user_id: @objective.user_id }
    assert_redirected_to objective_path(assigns(:objective))
  end
